package com.luizmoneyapi.exceptionhandeler;
...
public class LuizMoneyExceptionHandeler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(RuntimeException ex, WebRequest request) {
		...
		String mensagemUsuario = messageSource.getMessage("mensagem.recurso-nao-encontrado", null, request.getLocale());
		String mensagemDesenvolvedor =  ex.toString();
		List<Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemDesenvolvedor));
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request){
		String mensagemUsuario = messageSource.getMessage("mensagem.operacao-nao-permito", null, request.getLocale());
